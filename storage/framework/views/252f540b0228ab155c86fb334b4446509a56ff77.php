        ...
        <div class="bg-neutral-200 w-96 h-full pb-8 rounded-lg my-8 mx-auto">
            ...
            <form action="/login" method="POST">
                ...
                <div class="ml-4 mr-12">
                    ...
                    <input name="email" type="email" class="rounded-md p-1 hover:shadow-md w-full" placeholder="Email" value="<?php echo e(old('email')); ?>">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="ml-4 mr-12 mt-4">
                    ...
                    <input name="password" type="password" class="rounded-md p-1 hover:shadow-md w-full" placeholder="Password" value="<?php echo e(old('password')); ?>">
...
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?>
<?php /**PATH C:\Users\hdahmed\Desktop\Software Portfolio\Laravel\Airlinesite\resources\views/login/login.blade.php ENDPATH**/ ?>